...
def draw_heuristic2(state,poslist,dirtlist,vaccum):
	cost=0
	if(state[9][0]==1):
		cleanDirt_heuristic(poslist[(9,9)][0],poslist[(9,9)][1])
		cost+=1
		state[9][9]=0
	x,y=9,9
	print(poslist)
	...
	while(not(checkstate(state))):
		...
		vaccum.color("blue")
		vaccum.penup()
		vaccum.goto(vir_x+10,vir_y-10)
		vaccum.pendown()
		print(vir_x,vir_y,vir_nextx,vir_nexty)
		vaccum.goto(vir_x+10,vir_nexty-10)
		vaccum.goto(vir_nextx+10,vir_nexty-10)
