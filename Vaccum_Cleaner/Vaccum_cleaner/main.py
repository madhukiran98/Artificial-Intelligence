...
from heuristic import idfs2,checkstate,cleanDirt_heuristic,draw_heuristic1, draw_heuristic2
def main():

	percent=int(raw_input("Enter the percentage of dirt on the floor:"))
	window=Screen()
	...
	draw_heuristic2(copy.deepcopy(tileList),tilePos2,posList2,vac2)
	printgrid(tileList)
	posList1,posList2=dirt_positions(tileList)
	l=[tileList,[0,0],-1]
	tree=node(l)
